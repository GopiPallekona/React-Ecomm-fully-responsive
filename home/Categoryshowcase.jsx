...
const Categoryshowcase = () => {
    ...
    // category wise functionality
const filterItem=(categItem)=>{
const updateditems=ProductData.filter((curEle)=>{
                    ...
                    <div className="course-item style-4">
                        <div className="course-inner">
                            <div className="course-thumb">
                                ...
                                <div className="couse-category d-flex " style={{justifyContent:"space-around",alignItems:"center",background:" #FFDF40"}}>
                            ...
                            <div className="course-content">
                                <Link to={`/src/${product.id}`}><h6>{product.title}</h6></Link>
